  ...
  const MusicList = [
    {
      ...
      musicLink:
        "https://open.spotify.com/album/3ZSu3LsLWTSdUzjtzxeXu0?si=LqnGgOsjRS-lfwbQDRb2Fw",
    },
    {
      name: "Apple Music",
      imgSrc: "https://services.linkfire.com/logo_applemusic_onlight.svg",
      musicLink:
        "https://music.apple.com/tw/album/%E7%8D%B5%E5%BF%83-single/1787969302",
    },
    {
      name: "KKBox",
      imgSrc: "https://www.kkbox.com/about/img/logo/logo.svg",
      musicLink: "https://kkbox.fm/maI785",
    },
    {
      name: "YouTube Music",
      imgSrc:
      ...
      musicLink:
        "https://music.youtube.com/playlist?list=OLAK5uy_mZMBx4smj0YYbYp67OWfPvw5KzcPbNQ-E&si=DERDJTvVbOM-n4U2",
    },
    {
      name: "StreetVoice",
      imgSrc:
      ...
      musicLink:
        "https://streetvoice.com/whitefrequency2016/songs/album/97322807/",
    },
    {
      name: "Line Music",
      imgSrc: "https://cdn.worldvectorlogo.com/logos/line-music.svg",
      musicLink: "https://music-tw.line.me/album/7595782",
    },
    {
      name: "WangYiYun",
      imgSrc: "https://services.linkfire.com/logo_netease_onlight.svg",
      musicLink: "https://music.163.com/#/album?id=257817510",
    },
  ];
      ...
      <div className=" relative w-full  flex flex-col items-center min-h-screen gap-8 p-8 bg-cover bg-center bg-no-repeat">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4">
          ...
          <Card className="w-full min-w-[350px]">
            <CardHeader>
              <CardTitle className="text-center">獵心 Seductor</CardTitle>
